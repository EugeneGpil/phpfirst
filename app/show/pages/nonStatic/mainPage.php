        ...
        <div class="article-preview">
          ...
          <div class="article-preview__information-container">
            ...
            <div class="article-preview__category article-preview__interactive-button-container">
              ...
              <a href="<?= '/' . $urls['articles'] . '/' . $article['category_url'] ?>" class="article-preview__category article-preview__interactive-button"><?= $article['category_title'] ?>
              </a>
            </div>
...
foreach ($articlesByCategories as $articlesByCategory) {
  ...
  <section class="main-content">
    <div class="section__header">
      <a href="<?= $toCategoryUrl ?>" class="section__headline content__button_grey-theme"><?= $articlesByCategory[0]['category_title'] ?></a>
      <a href="<?= $toCategoryUrl ?>" class="main-content__header-button content__button_grey-theme">все записи</a>
    </div>
    <div class="main-content__articles-container">
      <?php
      $i = 0;
