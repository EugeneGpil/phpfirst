...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 12 2019 г., 00:50
...
(1, 'спорт', '/sport'),
(2, 'кулинария', '/kulinariya'),
(3, 'автомобили', '/avtomobili'),
(4, 'программирование', '/programmirovaniye'),
(5, 'природа', '/priroda'),
(6, 'безопасность', '/bezopasnost');
